...
extern __inline _IEEE64 strtod(const _INT8 * restrict, _INT8 ** restrict);
                    ...
                    extern void BZ2_bsInitWrite(struct anonymous_w2c_3 *);

                    static void bsFinishWrite(struct anonymous_w2c_3 *);

                    static void bsW(struct anonymous_w2c_3 *, _INT32, _UINT32);

                    static void bsPutUInt32(struct anonymous_w2c_3 *, _UINT32);

                    static void bsPutUChar(struct anonymous_w2c_3 *, _UINT8);

                    static void makeMaps_e(struct anonymous_w2c_3 *);

                    static void generateMTFValues(struct anonymous_w2c_3 *);

                    static void sendMTFValues(struct anonymous_w2c_3 *);
                    ...
                    extern void BZ2_hbMakeCodeLengths(_UINT8 *, _INT32 *, _INT32, _INT32);

                    extern void BZ2_hbAssignCodes(_INT32 *, _UINT8 *, _INT32, _INT32, _INT32);

                    extern void BZ2_compressBlock(struct anonymous_w2c_3 *, _UINT8);

                    extern void BZ2_blockSort(struct anonymous_w2c_3 *);

                    static void __ompdo_generateMTFValues1();

                    static void __ompdo_generateMTFValues2();

                    static void __ompdo_sendMTFValues1();

                    static void __ompdo_sendMTFValues2();

                    static void __ompdo_sendMTFValues3();

                    static void __ompdo_sendMTFValues4();

                    static void __ompdo_sendMTFValues5();

                    static void __ompdo_sendMTFValues6();

                    static void __ompdo_sendMTFValues7();

                    static void __ompdo_sendMTFValues8();
