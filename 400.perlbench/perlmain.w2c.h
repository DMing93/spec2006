...
extern _INT32 main(_INT32, _INT8 **, _INT8 **);

extern _INT32 PL_use_safe_putenv;

extern _INT8 PL_do_undump;

extern struct interpreter * perl_alloc(void);

static struct interpreter * my_perl;

extern void exit(_INT32);

extern void perl_construct(struct interpreter *);

extern _INT32 PL_perl_destruct_level;

extern _UINT8 PL_exit_flags;

extern _INT32 perl_parse(struct interpreter *, void(*)(void), _INT32, _INT8 **, _INT8 **);

static void xs_init(void);

extern _INT32 perl_run(struct interpreter *);

extern _INT32 perl_destruct(struct interpreter *);
...
extern void boot_Cwd(struct cv *);

extern void boot_Data__Dumper(struct cv *);

extern void boot_Devel__Peek(struct cv *);

extern void boot_Digest__MD5(struct cv *);

extern void boot_IO(struct cv *);

extern void boot_MIME__Base64(struct cv *);

extern void boot_Sys__Hostname(struct cv *);

extern void boot_Time__HiRes(struct cv *);

extern void boot_attrs(struct cv *);
