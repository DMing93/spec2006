...
static struct he * S_new_he(void);

extern struct he * PL_he_root;

static void S_more_he(void);

static void S_del_he(struct he *);

extern void * Perl_safesysmalloc(_UINT64);

extern struct xpv * PL_he_arenaroot;

static struct hek * S_save_hek_flags(const _INT8 *, _INT32, _UINT32, _INT32);

extern void Perl_safesysfree(void *);

extern void Perl_free_tied_hv_pool(void);

extern struct he * PL_hv_fetch_ent_mh;

static void S_hv_notallowed(_INT32, const _INT8 *, _INT32, const _INT8 *);
...
static struct he * S_hv_fetch_common(struct hv *, struct sv *, const _INT8 *, _UINT64, _INT32, _INT32, struct sv *, _UINT32);
...
static void S_hv_magic_check(struct hv *, _INT8 *, _INT8 *);
...
static _UINT32 anon1;

extern _UINT64 PL_rehash_seed;

static _UINT32 anon2;

static struct hek * S_share_hek_flags(const _INT8 *, _INT32, _UINT32, _INT32);

extern void Perl_unshare_hek(struct hek *);
...
static void S_hsplit(struct hv *);
...
static struct sv * S_hv_delete_common(struct hv *, struct sv *, const _INT8 *, _UINT64, _INT32, _INT32, _UINT32);
...
static _UINT32 anon3;

static _UINT32 anon4;

extern void Perl_hv_free_ent(struct hv *, struct he *);

extern void Perl_hv_clear_placeholders(struct hv *);

extern _INT8 PL_nomemok;

extern _UINT32 PL_nice_chunk_size;

extern _INT8 * PL_nice_chunk;

extern struct hv * PL_strtab;

static _UINT64 anon5;
...
extern void Perl_hv_delayfree_ent(struct hv *, struct he *);

extern void Perl_hv_clear(struct hv *);

extern struct sv * Perl_hv_iterkeysv(struct he *);

static void S_hfreeentries(struct hv *);
...
extern struct sv * Perl_hv_iternextsv(struct hv *, _INT8 **, _INT32 *);

extern void Perl_hv_magic(struct hv *, struct gv *, _INT32);

extern void Perl_sv_magic(struct sv *, struct sv *, _INT32, const _INT8 *, _INT32);

extern void Perl_unsharepvn(const _INT8 *, _INT32, _UINT32);

static void S_unshare_hek_or_pvn(struct hek *, const _INT8 *, _INT32, _UINT32);
...
extern struct hek * Perl_share_hek(const _INT8 *, _INT32, _UINT32);
