...
extern void Perl_vdeb(const _INT8 *, struct __va_list_tag(*)[1LL]);

extern _INT32 Perl_debstackptrs(void);

static void S_deb_stack_n(struct sv **, _INT32, _INT32, _INT32, _INT32);
