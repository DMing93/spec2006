...
extern void Perl_boot_core_xsutils(void);

extern struct cv * Perl_newXS(_INT8 *, void(*)(struct cv *), _INT8 *);

extern void XS_attributes_bootstrap(struct cv *);

static _INT32 modify_SV_attributes(struct sv *, struct sv **, struct sv **, _INT32);

extern _INT8 * Perl_sv_2pv_flags(struct sv *, _UINT64 *, _INT32);

extern void Perl_croak(const _INT8 *, ...);

extern void(*PL_sharehook)(struct sv *);
...
extern void XS_attributes__warn_reserved(struct cv *);

extern void XS_attributes__modify_attrs(struct cv *);

extern void XS_attributes__guess_stash(struct cv *);

extern void XS_attributes__fetch_attrs(struct cv *);

extern void XS_attributes_reftype(struct cv *);
