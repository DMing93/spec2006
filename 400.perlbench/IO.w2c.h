...
struct iovec {
  ...
  struct sv {
      ...
      struct __dirstream;
                ...
                union anonymous_w2c_7 xio_dirpu;
                _INT64 xio_lines;
                _INT64 xio_page;
                _INT64 xio_page_len;
...
static _INT32 not_here(_INT8 *);

extern void Perl_croak(const _INT8 *, ...);

static _INT32 io_blocking(struct _PerlIO **, _INT32);
...
extern void XS_IO__Seekable_getpos(struct cv *);
...
extern _INT32 PerlIO_getpos(struct _PerlIO **, struct sv *);

extern struct sv PL_sv_undef;

extern void XS_IO__Seekable_setpos(struct cv *);

extern _INT32 PerlIO_setpos(struct _PerlIO **, struct sv *);
...
extern void XS_IO__File_new_tmpfile(struct cv *);

extern _INT8 * Perl_sv_2pv_nolen(struct sv *);

extern struct _PerlIO ** PerlIO_tmpfile(void);
...
extern void XS_IO__Poll__poll(struct cv *);

extern _INT64 Perl_sv_2iv(struct sv *);

extern _INT32 Perl_my_poll(struct pollfd *, _UINT64, _INT32);

extern struct sv * Perl_newSViv(_INT64);

extern void XS_IO__Handle_blocking(struct cv *);

extern void XS_IO__Handle_ungetc(struct cv *);
...
extern void XS_IO__Handle_error(struct cv *);

extern _INT32 Perl_PerlIO_error(struct _PerlIO **);

static struct sv * anon2;

extern void XS_IO__Handle_clearerr(struct cv *);

extern void Perl_PerlIO_clearerr(struct _PerlIO **);

static struct sv * anon3;

extern void XS_IO__Handle_untaint(struct cv *);

static struct sv * anon4;

extern void XS_IO__Handle_flush(struct cv *);

extern _INT32 Perl_PerlIO_flush(struct _PerlIO **);

extern void XS_IO__Handle_setbuf(struct cv *);

extern void XS_IO__Handle_setvbuf(struct cv *);

extern void XS_IO__Handle_sync(struct cv *);

extern void XS_IO__Socket_sockatmark(struct cv *);

extern _INT32 ioctl(_INT32, _UINT64, ...);

extern void boot_IO(struct cv *);
