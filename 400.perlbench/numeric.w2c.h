...
extern _IEEE64 Perl_scan_bin(_INT8 *, _UINT64, _UINT64 *);

extern _IEEE64 Perl_scan_oct(_INT8 *, _UINT64, _UINT64 *);

extern _IEEE64 Perl_scan_hex(_INT8 *, _UINT64, _UINT64 *);

extern _INT8 Perl_grok_numeric_radix(const _INT8 **, const _INT8 *);

extern _INT32 Perl_grok_number(const _INT8 *, _UINT64, _UINT64 *);

static _IEEE64 S_mulexp10(_IEEE64, _INT32);

extern _IEEE64 Perl_my_atof(const _INT8 *);

extern _INT8 * Perl_my_atof2(const _INT8 *, _IEEE64 *);
