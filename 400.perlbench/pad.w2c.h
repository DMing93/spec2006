...
extern _INT32 PL_padix;

extern _INT32 PL_comppad_name_fill;

extern _INT32 PL_min_intro_pending;

extern _INT32 PL_max_intro_pending;
...
extern void Perl_pad_reset(void);
...
extern _INT32 PL_comppad_name_floor;
...
extern _UINT32 Perl_cast_ulong(_IEEE64);

static _UINT64 S_pad_findlex(_INT8 *, _UINT64, struct cv *);

extern struct cv * PL_compcv;

static _INT32 anon5;

extern struct sv * Perl_pad_sv(_UINT64);

extern void Perl_pad_block_start(_INT32);

extern _INT32 PL_padix_floor;
...
static struct cv * S_cv_clone2(struct cv *, struct cv *);
