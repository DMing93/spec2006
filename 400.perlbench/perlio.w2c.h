...
struct iovec {
  ...
  struct interpreter {
    ...
    _UINT64 size;
    _UINT32 kind;
    _INT64(*Pushed)(struct _PerlIO **, const _INT8 *, struct sv *, struct _PerlIO_funcs *);
    _INT64(*Popped)(struct _PerlIO **);
    struct _PerlIO ** (*Open)(struct _PerlIO_funcs *, struct PerlIO_list_s *, _INT64, const _INT8 *, _INT32, _INT32, _INT32, struct _PerlIO **, _INT32, struct sv **);
    _INT64(*Binmode)(struct _PerlIO **);
    struct sv * (*Getarg)(struct _PerlIO **, struct clone_params *, _INT32);
    _INT64(*Fileno)(struct _PerlIO **);
    struct _PerlIO ** (*Dup)(struct _PerlIO **, struct _PerlIO **, struct clone_params *, _INT32);
    _INT64(*Read)(struct _PerlIO **, void *, _UINT64);
    _INT64(*Unread)(struct _PerlIO **, const void *, _UINT64);
    _INT64(*Write)(struct _PerlIO **, const void *, _UINT64);
    _INT64(*Seek)(struct _PerlIO **, _INT64, _INT32);
    _INT64(*Tell)(struct _PerlIO **);
    _INT64(*Close)(struct _PerlIO **);
    _INT64(*Flush)(struct _PerlIO **);
    _INT64(*Fill)(struct _PerlIO **);
    _INT64(*Eof)(struct _PerlIO **);
    _INT64(*Error)(struct _PerlIO **);
    void(*Clearerr)(struct _PerlIO **);
    void(*Setlinebuf)(struct _PerlIO **);
    _INT8 * (*Get_base)(struct _PerlIO **);
    _UINT64(*Get_bufsiz)(struct _PerlIO **);
    _INT8 * (*Get_ptr)(struct _PerlIO **);
    _INT64(*Get_cnt)(struct _PerlIO **);
    void(*Set_ptrcnt)(struct _PerlIO **, _INT8 *, _INT64);
  };
  struct _PerlIO {
  struct _PerlIO * next;
  struct _PerlIO_funcs * tab;
  _UINT32 flags;
};
struct __dirstream;
                    union anonymous_w2c_14 {
                  ...
                  union anonymous_w2c_14 xio_dirpu;
                  _INT64 xio_lines;
                  _INT64 xio_page;
                  _INT64 xio_page_len;
  ...
  struct anonymous_w2c_37 {
    struct _PerlIO base;
    _INT32 fd;
    _INT32 oflags;
  };
  struct anonymous_w2c_38 {
                struct _PerlIO base;
                struct _IO_FILE * stdio;
              };
              struct anonymous_w2c_39 {
    struct anonymous_w2c_32 base;
    _INT8 * nl;
  };
