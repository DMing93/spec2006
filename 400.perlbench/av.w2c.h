  ...
  struct subst {
            ...
            struct block_loop {
                ...
                struct block_sub {
                  ...
                  struct gv * gv;
                  struct gv * dfoutgv;
                  struct av_w2c_0 * savearray;
                  struct av_w2c_0 * argarray;
                  _INT64 olddepth;
                  _UINT8 hasargs;
                  _UINT8 lval;
                  struct av_w2c_0 * oldcomppad;
                };
                union anonymous_w2c_10 {
          ...
          struct context {
          _UINT32 cx_type;
          union anonymous_w2c_9 cx_u;
        };
        struct stackinfo {
        struct av_w2c_0 * si_stack;
...
extern __inline _UINT32 gnu_dev_major(_UINT64);
      ...
      extern struct av * Perl_av_fake(_INT32, struct sv **);
      ...
      static struct stackinfo * anon12;

      static struct av * anon13;

      extern void Perl_av_unshift(struct av *, _INT32);

      static struct av * anon14;

      static _INT32 anon15;

      static struct stackinfo * anon16;

      static struct av * anon17;

      extern struct sv * Perl_av_shift(struct av *);

      static struct av * anon18;
      ...
      static struct av * anon23;

      static _INT32 anon24;

      static struct stackinfo * anon25;

      static struct av * anon26;
      ...
      static _INT32 S_avhv_index_sv(struct sv *);

      extern _INT64 Perl_sv_2iv(struct sv *);

      static _INT32 S_avhv_index(struct av *, struct sv *, _UINT32);
      ...
      extern _INT32 Perl_sv_isa(struct sv *, const _INT8 *);
      ...
      static void __ompdo_Perl_av_extend1();

      static void __ompdo_Perl_av_extend2();

      static void __ompdo_Perl_av_fill1();
