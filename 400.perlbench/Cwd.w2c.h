...
static _INT8 * bsd_realpath();

extern _INT8 * getcwd(_INT8 *, _UINT64);

extern _INT32 chdir(const _INT8 *);

extern _INT32 * __errno_location(void);

extern void XS_Cwd_fastcwd(struct cv *);
...
extern _INT32 Perl_getcwd_sv(struct sv *);

static struct sv * anon1;

extern _INT32 Perl_mg_set(struct sv *);

extern void XS_Cwd_abs_path(struct cv *);
