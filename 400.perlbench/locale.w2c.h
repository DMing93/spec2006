...
extern void Perl_set_numeric_radix(void);

extern void Perl_new_numeric(_INT8 *);

extern void Perl_set_numeric_standard(void);

extern void Perl_set_numeric_local(void);

extern void Perl_new_ctype(_INT8 *);

extern void Perl_new_collate(_INT8 *);

extern _INT32 Perl_init_i18nl10n(_INT32);

extern _INT8 * getenv(const _INT8 *);

extern _UINT32 Perl_parse_unicode_opts(_INT8 **);

extern _UINT32 PL_unicode;

extern _INT32 Perl_init_i18nl14n(_INT32);
