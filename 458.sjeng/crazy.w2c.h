...
struct anonymous_w2c_1 {
  ...
  static _INT8 __PRETTY_FUNCTION___w2c_4619[12LL] = "SwitchColor";
  static _INT8 __PRETTY_FUNCTION___w2c_4628[15LL] = "SwitchPromoted";
  static _INT8 __PRETTY_FUNCTION___w2c_4659[14LL] = "removeHolding";
  static _INT8 __PRETTY_FUNCTION___w2c_4703[18LL] = "DropremoveHolding";
...
_INT32 holding[2LL][16LL];

_UINT32 hold_hash;

_INT32 white_hand_eval;

_INT32 black_hand_eval;

extern void reset_ecache(void);

_INT32 num_holding[2LL];

extern _UINT32 zobrist[14LL][144LL];

extern _INT32 Variant;

_INT32 userealholdings;

_INT8 realholdings[255LL];

extern _INT32 comp_color;

extern _INT32 text_to_piece(_INT8, _INT32);
