...
_IEEE32 cfg_scalefac;

_INT32 cfg_razordrop;

_INT32 cfg_cutdrop;

_INT32 cfg_futprune;

_INT32 cfg_smarteval;

_INT32 cfg_attackeval;
...
extern _INT8 setcode[30LL];

extern void initialize_eval(void);

extern void alloc_hash(void);

extern void alloc_ecache(void);

_INT32 cfg_booklearn;

_INT32 cfg_ksafety[15LL][9LL];

_INT32 cfg_tropism[5LL][7LL];

struct _IO_FILE * rcfile;
