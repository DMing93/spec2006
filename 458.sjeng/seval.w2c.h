...
struct anonymous_w2c_1 {
  ...
  static _INT8 __PRETTY_FUNCTION___w2c_4621[17LL] = "suicide_mid_eval";
...
static _INT32 s_bishop_mobility(_INT32);

extern _INT32 board[144LL];

static _INT32 s_rook_mobility(_INT32);

static _INT32 s_knight_mobility(_INT32);

static _INT32 s_pawn_mobility(_INT32);

static _INT32 s_king_mobility(_INT32);

static _INT32 black_saccers(_INT32);
...
static _INT32 white_saccers(_INT32);

extern _INT32 suicide_eval(void);

extern _INT32 suicide_mid_eval(void);
