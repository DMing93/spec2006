...
struct anonymous_w2c_1 {
  ...
  static _INT32 rook_o_w2c_4166[4LL] = {12, -12, 1, -1};
  static _INT32 bishop_o_w2c_4167[4LL] = {11, -11, 13, -13};
  static _INT32 knight_o_w2c_4168[8LL] = {10, -10, 14, -14, 23, -23, 25, -25};
...
extern void setup_attackers(_INT32);

_INT32 see_num_attackers[2LL];

extern _INT32 board[144LL];

struct anonymous_w2c_10 see_attackers[2LL][16LL];

extern void findlowest(_INT32, _INT32);
