...
_INT32 hand_value[13LL] = {0, 100, -100, 210, -210, 0, 0, 250, -250, 450, -450, 230, -230};

_INT32 std_hand_value[13LL] = {0, 100, -100, 210, -210, 0, 0, 250, -250, 450, -450, 230, -230};

extern void BegForPartner(void);

extern void GreetPartner();

extern _INT32 printf(const _INT8 *, ...);

extern void HandlePartner(_INT8 *);

extern _UINT32 have_partner;

extern _INT32 sscanf(const _INT8 *, const _INT8 *, ...);

extern _INT8 my_partner[256LL];
...
extern void gen(struct anonymous_w2c_42 *);

extern _INT32 numb_moves;

extern void make(struct anonymous_w2c_42 *, _INT32);

extern _UINT32 check_legal(struct anonymous_w2c_42 *, _INT32, _INT32);

extern void unmake(struct anonymous_w2c_42 *, _INT32);
