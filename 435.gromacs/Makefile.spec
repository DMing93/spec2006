...
commandexe       = gromacs_base.amd64-m64-gcc42-nn
...
compwhite        = 
configdir        = config
configpath       = /home/mmrb/spec/config/linux64-amd64-gcc42.cfg
copies           = 1
datadir          = data
delay            = 0
deletebinaries   = 0
...
log              = CPU2006
log_line_width   = 0
logname          = /home/mmrb/spec/result/CPU2006.005.log
lognum           = 005
mach             = default
mail_reports     = all
mailcompress     = 0
...
output_root      = 
outputdir        = output
path             = /home/mmrb/spec/benchspec/CPU2006/435.gromacs
plain_train      = 1
prefix           = 
prepared_by      = 
rate             = 0
...
review           = 0
run              = all
runspec          = /home/mmrb/spec/bin/runspec --config=linux64-amd64-gcc42 --size=test --noreportable --tune=base --iterations=1 fp
safe_eval        = 1
